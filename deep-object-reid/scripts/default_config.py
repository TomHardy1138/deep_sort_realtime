...
def get_default_config():
    ...
    cfg.data.workers = 0 # 4  # number of data loading workers
    ...
    cfg.metric_losses.additional_losses = CN()
    cfg.metric_losses.additional_losses.name = "cross_batch"
    ...
    cfg.data.transforms.segmentation = CN()
    cfg.data.transforms.segmentation.enable = False
