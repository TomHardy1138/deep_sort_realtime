...
from .image import (
    ...
    NEWPOST, NEWPOST_Test, Food, Food_Test, SimilarityDatasetCommon, SimilarityDatasetCommonTest
)
...
__image_datasets = {
    ...
    'lfw': LFW,
    'new_post': NEWPOST,
    'new_post_test': NEWPOST_Test,
    'food': Food,
    'food_test': Food_Test,
    'common': SimilarityDatasetCommon,
    'common_test': SimilarityDatasetCommonTest,
}
