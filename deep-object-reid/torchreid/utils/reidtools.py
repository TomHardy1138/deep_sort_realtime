...
def visualize_ranked_results(
    ...
    for q_idx in range(num_q):
        ...
        for g_idx in indices[q_idx, :]:
            ...
            result_distance = 1 - distmat[q_idx, g_idx]
            if not invalid:
                matched = gpid == qpid  # and result_distance >= 0.5
                if data_type == 'image':
        ...
        if data_type == 'image':
            ...
            cv2.imwrite(osp.join(save_dir, f"{imname}_{k}.jpg"), grid_img)
            k += 1
